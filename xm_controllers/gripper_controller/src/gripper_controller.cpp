...
namespace gripper_controller
{
    ...
    void GripperController::update(const ros::Time& time, const ros::Duration& period)
    {
            ...
            if(temp_cmd == 0)
            {
                joint_handle_[0].setGripperCmd(0);
                joint_handle_[1].setGripperCmd(0);
                
                joint_handle_[0].setCmd(-0.02);   
                joint_handle_[1].setCmd(-0.02);   
                
            }

            else if(temp_cmd == 1)
            {
                joint_handle_[0].setGripperCmd(1);
                joint_handle_[1].setGripperCmd(1);
            ...
            {
                joint_handle_[0].setGripperCmd(2);
                joint_handle_[1].setGripperCmd(2);
    ...
    void GripperController::goalCB(GoalHandle gh)
    {
        ...
        else if (position_gripper>-0.02&&position_gripper<0.02)
        {
            command_struct_ = 1;
        }
        else
    ...
    {
        joint_handle_[0].setGripperCmd(2);//1kai 0he
        joint_handle_[1].setGripperCmd(2);//1kai 0he
        
        joint_handle_[0].setCmd(0.0);
        joint_handle_[1].setCmd(0.0);
        
        command_struct_rt_ = 2;
